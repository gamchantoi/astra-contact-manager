...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset class="fields">
            <legend><%= Html.Resource("PPP_Resources, PPP_View_Pool_Create_CreateNewPool")%></legend>
            <p>
                <label for="Name"><%= Html.Resource("PPP_Resources, PPP_View_Pool_Create_Name")%></label>
                <%= Html.TextBox("Name") %>
                <%= Html.ValidationMessage("Name", "*") %>
            </p>
            <p>
                <label for="Addresses"><%= Html.Resource("PPP_Resources, PPP_View_Pool_Create_Addresses")%></label>
                <%= Html.TextBox("Addresses") %>
                <%= Html.ValidationMessage("Addresses", "*") %>
            </p>
            <p>
                <label for="NextPool"><%= Html.Resource("PPP_Resources, PPP_View_Pool_Create_NextPool")%></label>
